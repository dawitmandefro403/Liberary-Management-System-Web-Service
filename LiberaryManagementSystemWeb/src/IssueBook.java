...
public class IssueBook extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(t2.getText().equals("")) 
            JOptionPane.showMessageDialog(this,"Please Enter the Registered User ID or Book ID");
        else
        {
        ...
        List data = port.issuedByBookId(bid);
            ...
            if(data.size()!=0)
            {
                if(t6.getText().equals("YES"))
                {
                    ...
                    int ins = port.insertIssueBook(sid,sname,bid,bname,Address,issuedate,SStream,SClass);
                    JOptionPane.showMessageDialog(this,"Book with id = "+bid+" has been issued to "+sname);
                    System.out.println(ins + " row affected");
                    
                    int up = port.updateBook("NO", bid);
                    System.out.println(up + " row affected");
...
//                    }
    ...
    private void t1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t1KeyReleased
        ...
        LiberaryServer port = service.getLiberaryServerPort();
        String sid = t1.getText();
        List data = port.issuedByStudentId(sid);
        
        int i=0;
        if(i<data.size()){
            //1 2 3 5
            SName = (String)data.get(i+1);
            SStream = (String)data.get(i+2);
            SClass = (String)data.get(i+3);
...
//        }
    ...
    private void t3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t3KeyReleased
        ...
        if(i<data.size()){
            //1 2 3 5
            t4.setText((String)data.get(i+1));
            t6.setText((String)data.get(i+5));
        //System.out.println(data.get(i)+"\t"+data.get(i+1)+"\t"+data.get(i+2));
        i=i+6;
    }
            else
