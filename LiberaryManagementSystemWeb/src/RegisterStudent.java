...
//        connect();
        ...
        String saddress = a1.getText();
        int reg = port.studentRegister(sid,sname,sstream,sclass,saddress);
        JOptionPane.showMessageDialog(this,"Thank you "+sname+"\nYou are registered now");
        System.out.println(reg + " row affected");
