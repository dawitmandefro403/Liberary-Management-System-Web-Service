...
//    String query;
    ...
    private void t1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t1KeyReleased
        ...
        List data = port.studentReturn(sid);
        ...
        while(i<data.size()){
            n++;
            //1 2 3 5
            t2.setText((String)data.get(i+1));
            t3.setText((String)data.get(i+2));
            t4.setText((String)data.get(i+3));
            t5.setText((String)data.get(i+5));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        List data = port.studentReturn(sid);
            ...
            if(data.size()!=0)
            {
                ...
                String issuedon = t5.getText();
                String returndate = t6.getText();
                int ins = port.insertReturnDetail(sid,sname,bid,bname,issuedon,returndate);
                System.out.println(ins + " row affected");
                                                
                int del = port.deleteIssue(sid);
                System.out.println(del + " row affected");
                
                int up = port.updateBook("YES", bid);
