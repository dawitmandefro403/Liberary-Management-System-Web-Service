...
//    String query;
    ...
    private void c2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c2ActionPerformed
        ...
        List data = port.bookDetailByStream(bstream,bclass);
        ...
        int i=0;
        while(i<data.size()){
            BId = ((String)data.get(i));
            Bname = ((String)data.get(i+1));
            Bauthor = ((String)data.get(i+2));
            strm = ((String)data.get(i+3));
            cls = ((String)data.get(i+4));
            avl = ((String)data.get(i+5));
...
//        }
    ...
    private void txt1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt1KeyReleased
        ...
        List data = port.bookDetailByName(bname);
