...
//    String query;
    ...
    private void initComponents() {
        ...
        c3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Stream", "Software", "CS", "IT", "Other" }));
    ...
    private void c3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c3ActionPerformed
        ...
        if(c3.getSelectedItem()=="Software")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("G1-SEng");c4.addItem("G2-SEng");c4.addItem("G3-SEng");c4.addItem("G4-SEng");c4.addItem("G5-SEng");
        }
        if(c3.getSelectedItem()=="CS")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("G1-CS");c4.addItem("G2-CS");c4.addItem("G3-CS");c4.addItem("G4-CS");
        }
        if(c3.getSelectedItem()=="IT")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("G1-IT");c4.addItem("G2-IT");c4.addItem("G3-IT");c4.addItem("G4-IT");
        }
        if(c3.getSelectedItem()=="Other")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("Civil");c4.addItem("Electrical");c4.addItem("Architecture");c4.addItem("Mechanical");c4.addItem("Hydrolics");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String bid = txt2.getText();
        String bname = txt3.getText();
        String bauthor = txt4.getText();
        String bstream = (String)c3.getSelectedItem();
        String bclass = (String) c4.getSelectedItem();
        int add = port.addBook(bid,bname,bauthor,bstream,bclass,"YES");
        JOptionPane.showMessageDialog(this,"New book added to Library");
        System.out.println(add + " row affected");
